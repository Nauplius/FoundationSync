...
Write-Host -ForegroundColor DarkYellow "Release Date: 05/25/1015"
Write-Host -ForegroundColor DarkYellow "Version: 2.6RC"
Write-Host -ForegroundColor DarkYellow "Platform: SharePoint 2010"
Write-Host

$messageTitle = "Install FoundationSync"
$message = "Do you want to install FoundationSync for SharePoint 2010?"
